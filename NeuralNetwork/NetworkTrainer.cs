...
namespace Brain.NeuralNetwork
{
	public class NetworkTrainer
	{
		...
		public NetworkTrainer(Network network, double learningRate = 0.1,
			double regularizationRate = 0.1)
		{
			_network = network;
		...
		public NetworkTrainer(Network network, double learningRate,
			double regularizationRate, IErrorFunction errorFunction)
		{
			_network = network;
